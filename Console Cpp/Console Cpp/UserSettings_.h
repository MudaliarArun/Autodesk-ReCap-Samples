...
#define CONSUMER_KEY U("your consumer key")
#define CONSUMER_SECRET U("your consumer secret key")
...
#define ReCapClientID U("your ReCap client ID")
//#define ReCapKey U("your ReCap client key") // not used anymore
#define ReCapUserID U("your ReCap user ID") // Needed only for using the ReCapSceneList, otherwise bail
