...
// ZipKit
#define COCOAPODS_POD_AVAILABLE_ZipKit
#define COCOAPODS_VERSION_MAJOR_ZipKit 1
#define COCOAPODS_VERSION_MINOR_ZipKit 0
#define COCOAPODS_VERSION_PATCH_ZipKit 1
